...
class AppStore extends Component {
  ...
  render() {
    ...
    const filteredData = appsList.filter(each => each.category === activeTab)
    const filteredList = filteredData.filter(each =>
    ...
    return (
      <div className="bg-container">
        ...
        <ul className="app-container">
          {(searchInput !== null ? filteredList : filteredData).map(each => (
